...
BatchSize= 32
Target_Size=(24,24)
train_batch= generator('dataset_new/train',shuffle=True, batch_size=BatchSize,target_size=Target_Size)
valid_batch= generator('dataset_new/test',shuffle=True, batch_size=BatchSize,target_size=Target_Size)
...
#randomly turn neurons on and off to improve convergence
    Dropout(0.25), 
#to fight overfitting, 0.5 to 0.8
...
model.save('mdls/cnnmdl2.h5', overwrite=True)